...
//var translation = [0, 0, 0]; //x-y-z of F
//var rotation = [0, 0, 0];
//var scale = [1.0, 1.0, 1.0]; //default scale

var CamAngle_Radians = 0;
var angleFOV = 60;
var angleCam = 0;
...
var cameraPosition = [0, 0, 0]; //eye/camera coordinates
...
window.onload = function init()
{
	...
	CamAngle_Radians = degToRad(0);
    FOV_Radians = degToRad(60);
    aspect = canvas.width / canvas.height;
    zNear = 1;
    zFar = 2000;
	
	numFs = 5; //number of letter F
	radius = 200;
	...
	gl.vertexAttribPointer(colorLocation, 3, gl.UNSIGNED_BYTE, true, 0, 0); //normalize RGB 0 - 255 to 0.0 - 1.0
	...
	document.getElementById("sliderCam").onchange = function(event) {		
		...
		CamAngle_Radians = degToRad(event.target.value);
		render();
    };
...
function render() 
{
	...
	cameraMatrix = m4.yRotation(CamAngle_Radians);
